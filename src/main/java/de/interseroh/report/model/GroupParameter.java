...
public interface GroupParameter extends Parameter {
    ...
    /**
     * @param parameters List or null to clear parameter list
     */
     ...
     * @param parameter ScalarParameters
     * @return this object
     */
    ...
    /**
     * @param cascading true if it is an cascading group
    ...
    /**
     * Indicates that this group is not configured within the reports.
     * Synthetic parameter groups wrappes parameters without any group within a report.
     * So that every scalar parameter is in a group and on the first level only parameter group exists.
     * @return
     */
    boolean isSynthetic();
    ...
    /**
     *
     * @param synthetic true if it is synthetic
     * @return the same GroupParameter instance
     */
